...
6. An eligible TrueX or IDVx placeholder pauses IMA. The app extracts trafficking parameters or a valid config
   URL, hides the player, and starts `TruexAdRenderer`.
